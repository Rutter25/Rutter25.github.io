...
cFunc["anim_check"] = function(_, wep, bodypart)
	if(wep == 25)  and (bodypart == 9) then
		setPedAnimation(source, "ped", "KO_shot_face", 10000, false, true, false)
	elseif(wep == 25)  and (bodypart == 8) then
		setPedAnimation(source, "CRACK", "crckdeth2", 10000, false, true, false)
	elseif(wep == 25)  and (bodypart == 7) then
		setPedAnimation(source, "CRACK", "crckdeth2", 10000, false, true, false)
	elseif(wep == 25)  and (bodypart == 6) then
		setPedAnimation(source, "CRACK", "crckdeth2", 10000, false, true, false)
	elseif(wep == 25)  and (bodypart == 5) then
		setPedAnimation(source, "CRACK", "crckdeth2", 10000, false, true, false)
	elseif(wep == 25)  and (bodypart == 4) then
		setPedAnimation(source, "CRACK", "crckdeth3", 10000, false, true, false)
	elseif(wep == 25)  and (bodypart == 3) then
		setPedAnimation(source, "ped", "KO_shot_stom", 10000, false, true, false)
	elseif(wep == 25)  and (bodypart == 2) then
		setPedAnimation(source, "CRACK", "crckdeth2", 10000, false, true, false)
	elseif(wep == 25)  and (bodypart == 1) then
		setPedAnimation(source, "CRACK", "crckdeth2", 10000, false, true, false)
